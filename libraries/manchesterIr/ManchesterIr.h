...
This code is based on the Atmel Corporation ManchesterIr
...
"ManchesterIr coding states that there will always be a transition of the message signal
...
We use Timing Based ManchesterIr Decode.
